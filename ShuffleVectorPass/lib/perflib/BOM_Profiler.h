...
static inline BOM_Table * init_BOM_timer () {
...
static void dump_BOM_table(BOM_Table * timer_table) {
...
static inline void destroy_BOM_timer(BOM_Table * timer_table) {
	if(timer_table) {
		free(timer_table);
	}
