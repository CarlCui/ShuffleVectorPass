...
#ifndef IDISA_SSSE3_CPP
#define IDISA_SSSE3_CPP
#include <stdint.h>
#include "../config.hpp"
...
//The total number of operations is 40.0
template <> IDISA_ALWAYS_INLINE bitblock128_t simd128<128>::abs(bitblock128_t arg1)
{
...
template <> IDISA_ALWAYS_INLINE bitblock128_t hsimd128<32>::packl(bitblock128_t arg1, bitblock128_t arg2)
{
	return _mm_hsub_epi16(simd_and(arg2, simd128<32>::lomask()), simd_and(arg1, simd128<32>::lomask()));
}
