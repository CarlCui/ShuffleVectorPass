...
template <> IDISA_ALWAYS_INLINE bitblock128_t simd128<4>::min(bitblock128_t arg1, bitblock128_t arg2)
{
	return simd128<1>::ifh(simd128<4>::lt(arg1, arg2), arg1, arg2);
}
...
template <> IDISA_ALWAYS_INLINE bitblock128_t simd128<128>::min(bitblock128_t arg1, bitblock128_t arg2)
{
	return simd128<1>::ifh(simd128<128>::lt(arg1, arg2), arg1, arg2);
}
...
{
	return hsimd128<32>::signmask(simd128<32>::eq(arg1, simd128<32>::constant<4294967295ULL>())) == 15;
}
