#ifndef RuntimeInfoSet_HPP_
#define RuntimeInfoSet_HPP_

/*=============================================================================
  RuntimeInfoSet.hpp - s2k support for runtime properties and carry introduction.
...
// methods and resultant compiler complexity.
//
...
public:
	...
	{
		return simd_xor(cq[carryno], simd<BLOCK_SIZE>::constant<1>());
	}
    ...
    IDISA_ALWAYS_INLINE uint64_t getBlockBase() const {
        return block_base;
    }
    
    IDISA_ALWAYS_INLINE void blockBaseAdjust(uint16_t val)
	{
		block_base += val;
	}
...
// s2k Runtime environment variables
struct s2k {
	int BUFFER_SIZE;
} s2k;


#endif // RuntimeInfoSet_HPP_
